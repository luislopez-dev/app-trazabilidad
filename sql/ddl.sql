...
CREATE TABLE IF NOT EXISTS `app_trazabilidad`.`trazabilidad_duraznos` (
  `ID` INT NOT NULL,
  `lote_id` VARCHAR(45) NULL,
  `Finca_ID` INT NULL,
  `Planta_ID` INT NULL,
  `Bodega_Alimentos_ID` INT NULL,
  `Embarcacion_ID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `app_trazabilidad`.`Lotes` (
  ...
  `trazabilidad_duraznos_ID` INT NOT NULL,
  `Finca_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_Lotes_trazabilidad_duraznos1_idx` (`trazabilidad_duraznos_ID` ASC),
  INDEX `fk_Lotes_Finca1_idx` (`Finca_ID` ASC),
  CONSTRAINT `fk_Lotes_trazabilidad_duraznos1`
